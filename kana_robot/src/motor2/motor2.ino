...
CytronMD L_motor(PWM_DIR, 18, 19);   // PWM 1 = Pin 2, DIR 1 = Pin 4.
CytronMD R_motor(PWM_DIR, 4, 5);   // PWM 2 = Pin 16, DIR 2 = Pin 17.
...
void ARDUINO_ISR_ATTR leftEncoder()
{
...
void ARDUINO_ISR_ATTR rightEncoder()
{
...
//  Serial.begin(115200);
  ...
  attachInterrupt(encLA, leftEncoder, RISING);
